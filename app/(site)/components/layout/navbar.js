...
import { FaArrowRightLong, FaFacebook, FaInstagram, FaPinterest, FaTwitter, FaYoutube } from "react-icons/fa6";
        ...
        <header>
            <div className="md:py-4 py-2 bg-black/90">
                <div className="container flex justify-between items-center">
                    <div className="flex md:gap-2 gap-1 items-center">
                        ...
                        <h3 className="text-white md:text-lg text-base font-bold">Friday</h3>
                    </div>
                    <div className="flex items-center sm:gap-2 gap-1">
                        <span className="text-white sm:text-lg text-sm">Upto</span>
                        <span className="text-yellow-500 sm:text-[40px] text-base font-bold">59%</span>
                        <span className="text-white sm:text-[26px] text-sm font-medium">Off</span>
                    </div>
                    <div>
                        <Button name={<span className="flex gap-2 items-center ">Book Now <FaArrowRightLong /></span>} className="bg-yellow-500 cursor-pointer hover:bg-yellow-600" />
                    </div>
                </div>
            </div>
            <div className=" bg-[#1b6392] md:py-4 py-2 border-b border-b-white border-opacity-30">
                <div className="flex sm:flex-row flex-col items-center justify-between container">
                    <p className="text-white md:text-base text-sm">Welcome to Clicon online eCommerce store. </p>
                    <div>
            ...
            <div className=" bg-[#1b6392] md:py-4 py-2 border-b border-b-white">
                <div className="flex items-center justify-between container gap-4">
                    ...
                    <div className="bg-white md:flex hidden items-center gap-2 px-2 w-[653px] rounded-[4px]">
                        <Input onChange={(e) => console.log(e.target.value)} placeholder="Search for anything..." className="border-none" />
