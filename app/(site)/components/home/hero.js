      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center justify-center gap-6 h-[520px] w-[65%] bg-[#f2f4f5]">
          <div className="max-w-[356px]">
            ...
            <h2 className="xl-text-[60px] md:text-[40px] text-[26px] font-bold mb-4">
              Xbox Consoles
            </h2>
            <p className="text-gray-700 md:text-lg text-base mb-5">
            ...
            <Button
              ...
              className="bg-[#fa8232] cursor-pointer hover:bg-yellow-600 text-white w-fit"
            />
          </div>
